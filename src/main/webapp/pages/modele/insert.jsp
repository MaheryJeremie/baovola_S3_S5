...
<div class="container">
    ...
    <main class="main-content">
        <div class="dashboard-content">
            ...
            <form class="repair-form" method="post" action=<%=request.getContextPath()+"/modeleServlet"%>>
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        <label for="client">Modele</label>
                        <input type="text" id="client" placeholder="Nom du modele" name="nom">
                    </div>
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary">Créer le modele</button>
                    </div>
            </form>
        </div>
    </main>
