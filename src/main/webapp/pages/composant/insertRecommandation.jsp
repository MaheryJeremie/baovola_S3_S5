...
<div class="container">
    ...
    <main class="main-content">
        <div class="dashboard-content">
            <h1>Nouvelle recommandation de composant</h1>
            ...
            <form class="repair-form" method="post" action=<%=request.getContextPath()+"/insertionRecommendation"%>>
                <div class="form-grid">
                    <div class="form-group">
                        <label for="client">Marque</label>
                        <select name="idComposant">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="client" placeholder="Nom du modele" name="dateInsertion">
                    </div>
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary">Créer la recommandation</button>
                    </div>
            </form>
        </div>
    </main>
